...
Браузерный генератор деталей передач для 3D-печати: зубчатого шкива GT2, гладкого шкива (ролика натяжителя или обводного ролика ремня), эвольвентной шестерни с прямыми, косыми или шевронными зубьями и прямозубой конической шестерни для валов под углом. Параметры задаются по группам с поясняющими чертежами, деталь строится локально в фоновом потоке браузера. Результат виден в 3D и скачивается как STL. Основной интерфейс английский, русский — на странице `index_ru.html`.
